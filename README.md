...
<h4> <p align="center"> <a href="#creditos">Créditos</a> | <a href="#contexto">Contexto e objetivo</a> | <a href="#especificacao">Especificação</a> | <a href="#tecnologias">Tecnologias utilizadas</a> | <a href="#organizacao">Organização dos arquivos</a> <a href="execucao">Execução</a> | <a href="#equipe">Equipe</a> </p>
...
<h2 id="organizacao"> 📂 ORGANIZAÇÃO DOS ARQUIVOS DO PROJETO</h2>
```sh
```
